    ...
    <div class="container" style="padding:100px;">
      <div class="row">
        ...
        <div class="col-sm-3">
          ...
          <h5 class="normalFont text-center">Rahul Gandhi; is the VC of the Indian National Congress party and the Chairperson of the INC and the NSU of India.
            <hr>
            <ul class="text-left">
        ...
        <div class="col-sm-3">
          ...
          <h5 class="text-center normalFont">Arvind Kejriwal is an Telugu politician, who is the Second and current CM of Andhra Pradesh.</h5>
          <hr>
          <ul class="text-left">
            <li>Born: 16 August 1968, Siwani</li>
            <li>Full name: Arvind Kejriwal</li>
              <li>Parents: Gobind Ram Kejriwal and Gita Devi</li>
              <li>Siblings: Manoj Kejriwal</li>
              <li>Education: IIT KGP</li>
              <li>Awards: Ramon Magsaysay Award</li>
           
          </ul>
        </div>
        <div class="col-sm-3">
          <img src="images/mamta.jpg" class="img img-thumbnail" style="width:200px;height:200px;" alt="">
          <h4 class="normalFont text-center">Mamta Banarjee</h4>
          <h5 class="normalFont text-center"> Mamata Banerjee is an Indian politician who is serving as the ninth and current chief minister of West Bengal.</h5>
          <hr>
          <ul class="text-left normalFont">
            <li>Born: Sept 22, 1965 (age 50),</li>
            <li>Full name: Mamta Banarjee</li>
            <li>Parents: Promileswar Banerjee,Gayetri Devi.</li>
            <li>Siblings:  Babun Banerjee, Amit Banerjee, Kali Banerjee, Ganesh Banerjee, Ajit Banerjee, Samir Banerjee</li>
            <li>Education:  University of Calcutta, Jogomaya Devi College (JDC)</li>
            <li>Awards: UN Awards</li>
          </ul>
        </div>
      </div>
    </div>
